...
$categoriaEditada=$_REQUEST["categoriaEditada"];
if ($bandera == "add") {
  $consulta2  = "INSERT INTO categorias VALUES('null','" . $categoria . "',1)";
...
if ($bandera == "desactivar") {
  $consulta = "UPDATE categorias SET estado = '0' WHERE idcategoria = '".$baccion."'";
    $resultado = $conexion->query($consulta);
    msg("Exito.");
}
if ($bandera == "activar") {
  $consulta = "UPDATE categorias SET estado = '1' WHERE idcategoria = '".$baccion."'";
    $resultado = $conexion->query($consulta);
    msg("Exito.");
}
if ($bandera == "modificar") {
  $consulta = "UPDATE categorias SET categoria = '".$categoriaEditada."' WHERE idcategoria = '".$baccion."'";
    $resultado = $conexion->query($consulta);
    if ($resultado) {
      msg("Exito");
    }else {
...
function msg($texto)
{
    ...
    echo "alert('$texto');";
    echo "document.location.href='categorias.php';";
    echo "</script>";
}
?>
