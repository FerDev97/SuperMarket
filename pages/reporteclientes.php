...
<body>
  ...
  ?>
    <div id="reporte">
      <table border="0" width="100%">
        <tr>
          <th align="left" class="titulotabla">REPORTE LISTADO DE CLIENTES ACTIVOS</th>
      ...
      <table border="1" class="formatocontenidotabla" cellspacing=0 cellpadding=0 rules="all">
        <tr>
            ...
            <td width="300" align="center"><strong>Apellido</strong></td>
  ...
  $result =$conexion->query("select nombreclientes,apellidoclientes,estadousuario from clientes,usuarios where clientes.idusuario=usuarios.idusuario  AND estadousuario=1 order by nombreclientes");
  ...
  if ($result) {
    while($fila=$result->fetch_object()){
      ...
      echo "<td width='300'>".$fila->nombreclientes."</td>";
      echo "<td width='300'>".$fila->apellidoclientes."</td>";
      echo"</tr>";
      if($contador%$numeroFilas==0){
        $numPagina++;
        echo "</table>";
