          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                <span>Hola MAria Magdalena,</span>
                <h2>So fer</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Registro <small>Datos del proveedor.</small></h2>
...
<input type="hidden" name="baccion" id="baccion">
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="nombreProveedor" name="nombreProveedor" placeholder="Nombre.">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-right" id="direccionProveedor" name="direccionProveedor" placeholder="Direccion">
 ...
 <!-- DIV PARA PONER EL MAPA PARA EmpleadoS-->
              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>MAPA <small>Mapa Proveedor.</small></h2>
...
if ($bandera == "add") {
        $consultaProv  = "INSERT INTO proveedores VALUES('','".$nombreProveedor."','" . $direccionProveedor . "','".$latitud."','".$longitud."','1')";
        $resultado = $conexion->query($consultaProv);
        if ($resultado) {
          msg("Exito Proveedor");
        }else
        {
